...
for iProfile=1:length(profiles)
    ...
    for iGrid = 1:2
        ...
        for iMethod=1:length(methods)
            ...
            k = 0.1*k_star;
            [F,G,h,~,F2,N2G2,G2] = im.ModesAtWavenumber( k, 'F2', 'N2G2', 'G2' );
            [F_analytical,G_analytical,h_analytical,~,F2_analytical,N2G2_analytical,G2_analytical] = imAnalytical.ModesAtWavenumber( k, 'F2', 'N2G2', 'G2' );
