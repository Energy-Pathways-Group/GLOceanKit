classdef InternalWaveModelArbitraryStratificationOld < InternalWaveModel
    ...
    methods
        function self = InternalWaveModelArbitraryStratificationOld(dims, n, rho, z, latitude, varargin)
            if length(dims) ~=3
