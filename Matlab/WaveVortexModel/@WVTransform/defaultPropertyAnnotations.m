...
propertyAnnotations(end+1) = WVPropertyAnnotation('spectralMatrixSize',{},'', 'dimensional size of a spectral matrix, [Nj Nkl]', detailedDescription='- topic: Domain Attributes — Grid – Spectral');
...
propertyAnnotations(end+1) = WVPropertyAnnotation('spatialMatrixSize',{},'', 'dimensional size of a spatial matrix, [Nx Ny Nz]', detailedDescription='- topic: Domain Attributes — Grid – Spatial');
