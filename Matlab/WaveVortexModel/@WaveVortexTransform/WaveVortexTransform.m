...
%             end
            ...
            self.transformDimensionWithName('y') = TransformDimension('y',length(self.y), 'm', 'y-coordinate dimension');
            self.transformDimensionWithName('z') = TransformDimension('z',length(self.z), 'm', 'z-coordinate dimension');
