...
%MAKEFIGS_STOKES Makes all figures for Lilly et al. (2023).
%
%   This script makes all figures for the paper 
%
%   Lilly, Feske, Fox-Kemper, and Early (2023).  A tensor-valued integral
%       theorem for the gradient of a vector field, with a fluid dynamical 
%       application.  Submitted.
%
%   To run it, you will need the latest version of jLab, freely available
%   at http://www.jmlilly.net/code.html.
%
%   You'll also need to install the Crameri Perceptually Uniform Colormaps,
...
%   (C) 2023 J.M. Lilly --- type 'help jlab_license' for details
...
if strcmp(str,'--f')
     makefigs_stokes('noprint');return
end
