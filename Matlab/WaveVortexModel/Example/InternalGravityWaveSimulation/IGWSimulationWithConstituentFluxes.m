...
outputfile = '/Users/jearly/Data/InternalWaveSimulation/igw-simulation-constit-fluxes.nc';
...
outputVar = WVVariableAnnotation('E0_all_all',{},'m^3/s^2', 'flux into all, from all');
f = @(wvt) sum(sum(sum(wvt.energyFluxForFlowConstituents(WVFlowConstituent('all'),WVFlowConstituent('all')))));
wvt.addOperation(WVOperation('E0_all_all',outputVar,f));
...
outputVar = WVVariableAnnotation('E0_g_igw',{},'m^3/s^2', 'flux into E0, from geostrophic grad-wave');
f = @(wvt) sum(sum(sum(wvt.energyFluxForFlowConstituents(WVFlowConstituent('geostrophic'),WVFlowConstituent('wave')))));
wvt.addOperation(WVOperation('E0_g_igw',outputVar,f));
...
ncfile = model.ncfile;
[t,E0_all_all,E0_igw_igw,E0_igw_io,E0_igw_g,E0_io_igw,E0_io_g,E0_g_igw] = ncfile.readVariables('t','E0_all_all','E0_igw_igw','E0_igw_io','E0_igw_g','E0_io_igw','E0_io_g','E0_g_igw');

figure
plot(t/wvt.inertialPeriod,E0_all_all,'LineWidth', 4,'Color','k'), hold on
plot(t/wvt.inertialPeriod,E0_igw_igw,'LineWidth', 2)
plot(t/wvt.inertialPeriod,E0_igw_io,'LineWidth', 2)
plot(t/wvt.inertialPeriod,E0_igw_g,'LineWidth', 2)
plot(t/wvt.inertialPeriod,E0_io_igw,'LineWidth', 2)
plot(t/wvt.inertialPeriod,E0_io_g,'LineWidth', 2)
plot(t/wvt.inertialPeriod,E0_g_igw,'LineWidth', 2)
...
figure
plot(t(2:end)/wvt.inertialPeriod,diff(GeostrophicTotal)./diff(t))
xlabel('time (inertial periods)')
