classdef WVTotalFlowComponent < WVPrimaryFlowComponent
    ...
    methods
        ...
        function qgpvFactor = qgpvFactorForA0(self)
            ...
            for i=1:length(self.wvt.primaryFlowComponents)
                qgpvFactor = qgpvFactor + self.wvt.primaryFlowComponents(i).qgpvFactorForA0();
            end
        end
        ...
        function enstrophyFactor = enstrophyFactorForA0(self)
            ...
            for i=1:length(self.wvt.primaryFlowComponents)
                enstrophyFactor = enstrophyFactor + self.wvt.primaryFlowComponents(i).enstrophyFactor();
            end
        end
