...
+ Other
  ...
  + [`operationForDynamicalVariable`](/classes/wvtransform/operationfordynamicalvariable.html) We want to do the minimum computation required, which means we need to
